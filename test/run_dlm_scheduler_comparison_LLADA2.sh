...
RATES_MMLU="${RATES_MMLU:-1.5 2 2.5 3}"
RATES_HUMANEVAL="${RATES_HUMANEVAL:-10 12 14 16}"
RATES_MATH="${RATES_MATH:-2 2.5 3 3.5}"
RATES_GPQA="${RATES_GPQA:-2 2.5 3 3.5}"
RATES_SHAREGPT="${RATES_SHAREGPT:-2 2.5 3 3.5}"
RATES_RULER_4K="${RATES_RULER_4K:-4 5 6 7}"
