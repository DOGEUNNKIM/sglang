...
RATES_GSM8K="${RATES_GSM8K:-6 7 8 9}" # 결정
RATES_MMLU="${RATES_MMLU:-1 1.5 2 2.5}" # 결정
RATES_HUMANEVAL="${RATES_HUMANEVAL:-12 16 20 24}" # 결정
RATES_MATH="${RATES_MATH:-0.5 1 1.5 2}" # 결정
RATES_GPQA="${RATES_GPQA:-0.5 1 1.5 2}" # 결정
RATES_SHAREGPT="${RATES_SHAREGPT:-2 2.5 3 3.5}" # 결정
RATES_RULER_4K="${RATES_RULER_4K:-3.5 4 4.5 5}" # 결정
