...
RATES_GSM8K="${RATES_GSM8K:-10 11 12 13 14}" # 결정
RATES_MMLU="${RATES_MMLU:-1 1.5 2 2.5 3}" # 결정
...
RATES_SHAREGPT="${RATES_SHAREGPT:-2 2.5 3 3.5 4}" # 결정
RATES_RULER_4K="${RATES_RULER_4K:-3.5 4 4.5 5 5.5}" # 결정
