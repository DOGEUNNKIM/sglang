...
RATES_MMLU="${RATES_MMLU:-2.5 3 3.5 4}" # 완전 결정
RATES_HUMANEVAL="${RATES_HUMANEVAL:-10 12 14 16}" # 완전 결정
RATES_MATH="${RATES_MATH:-3 3.5 4 4.5}" # 완전 결정
RATES_GPQA="${RATES_GPQA:-1.5 2 2.5 3}" # 완전 결정
RATES_SHAREGPT="${RATES_SHAREGPT:-1.5 2 2.5 3}" # 완전 결정
RATES_RULER_4K="${RATES_RULER_4K:-3 3.5 4 4.5}" # 완전 결정
