...
# TP = 1일때 batch 32
RATES_GSM8K="${RATES_GSM8K:-12}" # 완전 결정
RATES_MMLU="${RATES_MMLU:-2.5 3 3.5 4}" # 
RATES_HUMANEVAL="${RATES_HUMANEVAL:-14 15 16 17}" # 완전 결정
RATES_MATH="${RATES_MATH:-3 3.5 4 4.5}" # 
RATES_GPQA="${RATES_GPQA:-1.5 2 2.5 3}" # 
RATES_SHAREGPT="${RATES_SHAREGPT:-1.5 2 2.5 3}" # 
RATES_RULER_4K="${RATES_RULER_4K:-3 3.5 4 4.5}" # 
...
PREFILL_FORWARD_TIME_S="${PREFILL_FORWARD_TIME_S:-0.04}"
DECODE_FORWARD_TIME_S="${DECODE_FORWARD_TIME_S:-0.04}"
################################

SCRATCH_ROOT="${SCRATCH_ROOT:-/mnt/nvme0/kdg6245}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${SCRATCH_ROOT}/dlm_sched_comparison_LLADA2_debug}"
