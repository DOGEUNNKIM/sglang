...
OUTPUT_ROOT="${OUTPUT_ROOT:-/tmp/dlm_sched_comparison_SDAR_baseline}"
...
CONFIG_PATH="${CONFIG_PATH:-/tmp/dlm_algo_config_sched_cmp_SDAR_baseline.yaml}"
STEP_LOG_FILE="${STEP_LOG_FILE:-/tmp/dlm_step_stats_SDAR_baseline.jsonl}"
REQUEST_LATENCY_LOG_FILE="${REQUEST_LATENCY_LOG_FILE:-/tmp/dlm_request_latency_SDAR_baseline.jsonl}"
BATCH_LATENCY_LOG_FILE="${BATCH_LATENCY_LOG_FILE:-/tmp/dlm_batch_latency_SDAR_baseline.jsonl}"
